...
/**
 *
 * @author Ing. Ray Cabrera 
 * @author Ferney Alberto Manco
 */
public class Validaciones {
   private static Validaciones validaciones = new Validaciones();
   ...
   public static Validaciones getInstance(){
     ...
     * @return Retorna una cadena sin caracteres alfabéticos, a menos que se encuetren en el parametro excepto.
     */

    public String Letras(String cadena,String excepto)
    {
     if(cadena.length()>0)
       {
        if(!excepto.equals(""))
     ...
     */
    public String numeros(String cadena, String excepto)
    {
     if(cadena.length()>0)
       {
         if(!excepto.equals(""))
     ...
     */
    public String numeros(String cadena)
    {
     if(cadena.length()>0)
       {
          if(cadena.substring(cadena.length()-1).matches("[0-9]"))
     ...
     * @return Retorna una cadena sin caracteres numéricos, a menos que se encuetren en el parametro excepto.
     */
    public  String caracteres(String cadena,String excepto)
    {
        //[a-z&&[^bc]]
     if(cadena.length()>0)
       {
     ...
     */
    public String validar(String cadena, String excl)
    {
        if(excl.length()<2)
        {
 ...
 * @return Retorna la cadena pasada como parámetro validada.
 */
    public String validar(String cadena, String excl, String excepto)
    {
        if(excl.length()<2)
        {
        switch(excl.charAt(0))
     ...
     * @return Retorna la cadena pasada como parámetro validada.
     */
public String excluir(String cadena, String excl,String excepto)
    {
 ...
 * @return
 */
public String excluir(String cadena, String excl)
    {
    String cadena1=cadena;
